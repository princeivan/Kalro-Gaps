  ...
  return (
    <nav>
      ...
      <div className='top-nav'>
        <ul>
        <ImLocation  style={{alignContent:"center"}}/> <li>{t('Our Location')} <span>KALRO, Kaptagat Rd</span></li>
        <IoMailUnread /><li>{t('Mail Us')} <span>info@kalro.org</span></li>
        <FaPhoneVolume /><li>{t('Contact Us')} <span>(+254) 0722 206 986</span></li>
        </ul>  
      </div>

      {/* Main Navigation */}
      <img src={Navbar1} alt="Kalro" />
      <div className='centered'>
        <h3 className='logo'>Climate Resilient Good Agricultural Practices(GAPS)</h3>
      ...
      <div className={scrollPage ? ' main-nav fixed' : 'main-nav'}>
       ...
       <ul>
        ...
        <Link to="/gaps"><li>{t('Gaps By Value Chain')}</li></Link>
